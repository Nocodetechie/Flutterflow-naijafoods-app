...
class _DishesWidgetState extends State<DishesWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DishesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<FoodsRecord>(
      stream: FoodsRecord.getDocument(widget.foodref!),
      builder: (context, snapshot) {
        ...
        final dishesFoodsRecord = snapshot.data!;
                    ...
                    Padding(
                      ...
                      child: StreamBuilder<List<DishesRecord>>(
                        stream: queryDishesRecord(
                          parent: dishesFoodsRecord.reference,
                        ),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
